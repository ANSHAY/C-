...
public:
    int maxSubarraySumCircular(vector<int>& A) {
        int res=A[0], cur=A[0];
        int i=0,j=1, s=A.size();
        if(s==1) return res;
        while(i<s){
            if(cur>=0 && A[j%s]>-cur){
                cur+=A[j%s];
            }
            else if(cur<=0 && A[j%s]>=cur){
                i=j;
                cur=A[i%s];
            }
            else{
...
[-5,4,-6]
[0,5,8,-9,9,-7,3,-2]
[5,1,4,7,8,9,6,5,2,3,0,1,4,7,8,5,6,9,8,5,3,2,1,4]
[1,0,2,4,7,8,5,6,9,8,5,6,3,2,1,4,7,8,4,1,2,2,5,8,9,6,3,2,5,4,4]
[-5,1,-4,7,-8,9,6,-5,2,3,0,1,-4,7,8,-5,6,9,-8,5,-3,2,-1,-4]
[1,0,-2,4,-7,8,5,-6,9,-8,5,-6,3,2,-1,4,-7,8,4,-1,2,0,2,-5,8,-9,6,-3,2,-5,-4,-4]
[-5,-1,-4,-7,-8,-9,-9,-5,-2,-3,0,-1,-4,-7,-8,-5,-6,-9,-8,-5,-3,-2,-1,-4]
[1,0,2,4,7,8,5,6,9,8,5,6,3,2,1,4,7,8,4,1,2,2,5,8,9,6,3,2,5,4,4]
